...
class TestJsonWriter(unittest.TestCase):
        ...
        exp_drug_resistance = \
            {'drugScores': [{'drug': {'displayAbbr': 'BIC', 'name': 'BIC'},
                            ...
                            {'drug': {'displayAbbr': 'RAL', 'name': 'RAL'},
                             ...
                             'text': 'High-Level Resistance'}],
             'gene': {'name': 'IN'},
             'version': {'publishDate': '2019-02-13', 'text': '8.8'}}
    ...
    def testFindComment(self):
        ...
        exp_text = \
            'V151I is an accessory INSTI selected mutation that occurs in' \
            ' 1% to 5% of viruses from ARV-naive patients depending on subtype. ' \
            'It appears to have little or no effect on INSTI susceptibility. V151L' \
            ' is an extremely rare non-polymorphic mutation that confers intermediate' \
            ' / high-level reduced susceptibility to RAL and EVG and low-level reduced' \
            ' susceptibility to DTG. V151A is an extremely rare non-polymorphic mutation' \
            ' associated with minimally reduced susceptibility to RAL and EVG. $listMutsIn{151(NOT IAL)} is an unusual mutation at this position.'
